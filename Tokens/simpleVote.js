let controllerAddr = '0x97c2454754b167a24879b0453388f6fdaba7a4b0';
...
let butterTokenAddr = '0xe8d38fD0Ed900890A6A2387B6cCBafFe72eAa3A3';
let butterAbi =
[
	{
		"constant": false,
...
let bakingMasteryAddr = '0xA1Dbf760e1F3fD057199dBAE78A0a4d20c981E77'; 
...
let tokenControllerContract;
let tokenController;
let butterContract;
let butterToken;
let bakingMasteryContract;
let bakingMastery;
let accountAddress;
...
function startApp() {
  tokenControllerContract = web3.eth.contract(controllerAbi); // controller
...
function getToken() {
  butterToken.getBalanceOf(function(e,r){
    document.getElementById('butterTokenValue').innerHTML = r.toString();
  });
...
function getTokenInfo() {
  ...
  butterToken.getInitialSupply(function(e,r){
    document.getElementById('butter-tokens-total').innerHTML = r.toString();
  });
  butterToken.getTotalSupply(function(e,r){
    document.getElementById('butter-tokens-sellable').innerHTML = r.toString();
  });
